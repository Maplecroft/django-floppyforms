// Originally generated by CoffeeScript 1.4.0; since hacked to bits by hand
(function() {
  var LeafletWidget,
  ...
  LeafletWidget = (function() {
    ...
    function LeafletWidget(options) {
      ...
      this.$ = $ || django.jQuery;
      L.mapquest.key = this.options.mapquest_token;
      this.map = new L.mapquest.map(this.options.map_id, {
          center: [37.7749, -122.4194],
          layers: L.mapquest.tileLayer(this.options.primary_map.toLowerCase()),
          zoom: 6
      });
